    ...
    <section id="services" class="services-section">
        <div class="container">
            <div class="row">
				<div class="col-lg-12">
					<div id="cs-para">
						<p>I am currently pursuing a B.S. in computer science at the University of Pittsburgh.
							Below you'll find listed the relevent courses I've completed as well as the programming
			...
			<div class="row">
                <div class="col-md-6">
					<div class="cs-list" id="class-list">
					
					</div>
                </div>
				
				<div class="col-md-6">
					<div class="cs-list" id="language-list">
